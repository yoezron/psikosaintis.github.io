...
Pastikan Anda mengatur tipe judul yang valid. Nilai dukungan adalah "disingkat", "diterjemahkan", "alternatif" dan "seragam".',
  ...
  'common.queue.long.submissionsUnassigned' => 'Belum Diproses',
  ...
  'submission.submit.whatNext' => 'Apa Selanjutnya?',
  'submission.submit.copyrightNoticeAgree' => 'Ya, Saya setuju mengikuti syarat pernyataan hak cipta.',
  'submission.submit.copyrightNoticeAgreementLabel' => 'Setujui pernyataan hak cipta',
  'submission.submit.submissionCompleteThanks' => 'Terima kasih Anda berminat menerbitkan naskah pada {$contextName}.',
  ...
  'submission.submit.submissionChecklist' => 'Persyaratan Mengirim Naskah',
  'submission.submit.userGroupDescriptionManagers' => 'Kirim dalam peran berikut jika ingin bisa menyunting dan menerbitkan naskah ini sendiri: {$managerGroups}',
  'submission.submit.contactConsentDescription' => 'Ya, Saya ingin dihubungi terkait naskah ini.',
  'submission.submit.contactConsent' => 'Narahubung Korenspondesi',
  ...
  'submission.confirm.message' => 'Naskah Anda telah diunggah dan siap dikirim. Anda masih bisa kembali mereview dan memperbaiki informasi yang kurang sebelum mengirim.nya Jika sudah siap, langsung klik "Kirim Naskah Selesai".',
  ...
  'submission.event.proofsApproved' => '"{$name}" ({$username}) telah menyetujui proof untuk "{$formatName}."',
  'submission.event.signoffSignoff' => '"{$name}" ({$username}) telah keluar pada signoff untuk "{$file}."',
  'submission.event.fileAuditUploaded' => '"{$name}" ({$username}) telah menyelesaikan pemeriksaan dan mengunggah "{$file}."',
  'submission.event.fileAuditorCleared' => '"{$name}" ({$username}) dihapus sebagai auditor untuk file "{$file}."',
  'submission.event.fileAuditorAdded' => '"{$name}" ({$username}) ditambahkan sebagai penulis untuk file "{$file}."',
  'submission.event.lastRevisionDeleted' => 'File "{$title}" dengan revisi terakhir dihapus oleh {$username}.',
  'submission.event.revisionDeleted' => 'Revisi file "{$originalFileName}" dihapus untuk naskah {$submissionId} oleh {$username}.',
  'submission.event.revisionUploaded' => 'Revisi file "{$originalFileName}" diunggah untuk naskah {$submissionId} oleh {$username}.',
  'submission.event.fileDeleted' => 'File "{$originalFileName}" dihapus untuk naskah masuk {$submissionId} oleh {$username}.',
  'submission.event.fileUploaded' => 'File "{$originalFileName}" diunggah untuk naskah masuk {$submissionId} oleh {$username}.',
  ...
  'editor.submission.decision.previousAuthorNotification' => 'Sebelumnya: Pemberitahuan Penulis',
  'editor.submission.decision.selectFiles' => 'Pilih file yang ingin diteruskan ke tahap {$stageName}.',
  'editor.submission.decision.nextButton' => 'Berikutnya: Pilih File untuk {$stageName}',
  ...
  'submission.submit.finishSubmission' => 'Selesaikan Kirim Naskah',
  ...
  'submission.event.fileRevised' => 'Revisi "{$name}" sudah diunggah untuk file {$submissionFileId}.',
  'submission.event.submissionSubmitted' => 'Pengiriman Naskah Awal Selesai.',
  'submission.event.participantRemoved' => '"{$name}" ({$username}) dihapus dari {$userGroupName}.',
  'submission.event.participantAdded' => '{$name} ({$username}) ditugaskan pada naskah ini sebagai {$userGroupName}.',
  ...
  'submission.event.fileEdited' => 'Metadata file "{$originalFileName}" telah diubah oleh {$username}.',
  ...
  'submission.submit.genre.error' => 'Pilihlah tipe file untuk setiap unggahan.',
